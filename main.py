...
file_path = os.path.join(os.path.dirname(__file__), "data", "Similar Player_22-05-11.csv")
df = pd.read_csv(file_path)
file_path2 = os.path.join(os.path.dirname(__file__), "data", "Similar Player Percentiles_22-05-11.csv")
df_per = pd.read_csv(file_path2)
